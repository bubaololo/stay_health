    ...
    <div class="container">
        <div class="call__text">
            ...
            <div class="call__text_title">
                Медицинский центр для детей и взрослых Инпромед имеет несколько подразделений для оказания услуги вызов
                врача на дом. В зависимости от ситуации, времени суток и дня недели медицинскую помощь Вашему ребенку
                окажут разные отделения нашей клиники. Мы гарантируем, что Вы не останетесь без поддержки.
            </div>
            <img src="img/call.jpg" alt="doctor call" class="call__img">
            <div class="call__text_content">Когда мы болеем, меньше всего нам хочется выходить из дома и идти в клинику,
                даже если там нет очередей и максимально комфортное обслуживание. В «Семейной клинике ВЕРА» на дом
                выезжают педиатр и терапевт. Также не выходя из дома можно сдать анализы.

                При вызове врача на дом, к Вам приедет грамотный доктор, который соберет анамнез, внимательно проведет
                осмотр. После этого врач установит диагноз, сделает лекарственные назначения и спланирует тактику
                дальнейшего ведения вас или вашего ребенка, а также подробно объяснит все нюансы.</div>
        </div>
            ...
            <div class="hystmodal__window" role="dialog" aria-modal="true">
                ...
                <section class="form">
                    ...
                    <div class="form__wrapper">
                        <form enctype="multipart/form-data" method="post" id="call__form"
                            ...
                            <div class="form__top">
                                ...
                                <div class="form__input_wrapper">
                                    ...
                                    <input id="call__name" type="text" name="call__name"
                                        class="form_input call__input_name" placeholder="Имя">


                                    <input id="call__last_name" type="text" name="call__last_name"
                                        class="form_input call__input_lastname" placeholder="Фамилия">
                                    ...
                                    <input id="call__phone" type="tel" name="call__phone" class="form_input input_phone"
                                        placeholder="+7___-___-__-__">
                                </div>
                                <input id="call__adress" type="text" name="call__adress" class="form_input call__adress"
                                    placeholder="Ваш адрес">

                                <textarea id="call__comment" name="call__comment" class="form_input input_comment"
                            ...
                            <div class="form__bottom">
                                ...
                                <div class="checkbox__wrapper">
                                    <label class="check option">
                                        <input type="checkbox" id="call__check" name="call__check" required
                                            class="check__input">
